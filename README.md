...
We've stripped down the user interface to highlight the Authorization Code Flow.  Our [Blackbaud code samples](https://developer.blackbaud.com/skyapi/docs/code) provide a rich user interface using [SKY UX](http://developer.blackbaud.com/skyux).
